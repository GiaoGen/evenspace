...
export function LocalDataCard({ summary, onManage }: { readonly summary: AccountSummary; readonly onManage: () => void }) {
  return (
    <button className={`${styles.dataCard} ${styles.reveal}`} type="button" onClick={onManage}>
      ...
      <span><small>Private cloud</small><strong>{summary.storedRooms} {summary.storedRooms === 1 ? "room" : "rooms"} connected to your account</strong><em>Room data and media are kept in private EventSpace storage.</em></span>
