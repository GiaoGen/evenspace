...
export function RoomsPage() {
  ...
  return (
    <div className={styles.page}>
      <AppHeader leading={<Link href="/account" className={styles.avatar} aria-label="Open account">{session.viewer.initials}</Link>} actions={<Link href="/rooms/new" className={styles.topCreateAction} aria-label="Create a room"><Icon name="plus" size={17} /></Link>} />
