...
const manifests = z.array(zineTemplateManifestSchema).length(2).parse([
  {
    ...
    pageFamilies: [
      { id: "quiet-single", minPhotos: 1, maxPhotos: 1, maxAnnotations: 1, allowedFits: ["cover"], density: "sparse" },
      { id: "quiet-dialogue", minPhotos: 2, maxPhotos: 2, maxAnnotations: 1, allowedFits: ["cover"], density: "balanced" },
      { id: "quiet-rhythm", minPhotos: 3, maxPhotos: 4, maxAnnotations: 0, allowedFits: ["cover"], density: "balanced" },
      { id: "quiet-pause", minPhotos: 1, maxPhotos: 1, maxAnnotations: 1, allowedFits: ["cover"], density: "sparse" },
    ],
  ...
  },
  {
    ...
    pageFamilies: [
      ...
      { id: "sequence-dialogue", minPhotos: 2, maxPhotos: 2, maxAnnotations: 1, allowedFits: ["cover"], density: "balanced" },
      { id: "sequence-establishing", minPhotos: 2, maxPhotos: 3, maxAnnotations: 1, allowedFits: ["cover"], density: "balanced" },
      { id: "sequence-contact", minPhotos: 3, maxPhotos: 5, maxAnnotations: 0, allowedFits: ["cover"], density: "dense" },
      { id: "sequence-detail", minPhotos: 1, maxPhotos: 2, maxAnnotations: 1, allowedFits: ["cover"], density: "balanced" },
    ],
    rhythm: { maxConsecutiveSameFamily: 2, maxConsecutiveDensePages: 1 },
    annotation: { placement: "photo-outer-corner", showCommentAuthor: true, showReflectionAuthor: false },
  },
