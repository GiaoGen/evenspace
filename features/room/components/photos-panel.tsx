...
export function PhotosPanel({
  ...
  return <section ref={panelRef} className={styles.panel} aria-label="Room photos">
    ...
    <div className={styles.grid}>
      ...
      {archived ? <Link className={`${styles.tile} ${styles.bookTile}`} href={`/rooms/${roomPublicId}/book`} aria-label="Open Book Studio"><Icon name="book" size={27} /><span>Book</span></Link> : null}
