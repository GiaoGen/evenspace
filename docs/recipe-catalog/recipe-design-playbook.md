...
不允许一次性完整设计 12 个。五个草图提供足够比较面，三个完整 Brief 则能保持坐标、内容状态和差异论证的质量。
...
```text
5 个结构草图 -> 3 个 Anchor
4 个新增结构草图 -> 选 3 个，累计 6
4 个新增结构草图 -> 选 3 个，累计 9
4 个新增结构草图 -> 选 3 个，累计 12
```

每家族实际探索约 17 个方向，只保留 12 个候选。被淘汰方向不得只换名称、镜像或配色后重新进入。
