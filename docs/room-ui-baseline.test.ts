...
const baseline = {
  "features/room/components/room-experience.tsx": "8D87E79BC2E47E70A171C7149EE27B733924C42ADBD26D9F235ECE10284EF214",
  "features/room/components/room-experience.module.css": "207CBE7BFE9ACE72801BEBAB95FA84E26FEE7084E3F7BCADFD817301F9281111",
  ...
  "features/room/components/photos-panel.tsx": "46746D8B9662E820B9252549C7EE8DF470112777BAC5C362379C56CA614A684E",
  ...
  it("keeps every protected visual component byte-for-byte unchanged", () => {
    for (const [file, expected] of Object.entries(baseline)) {
      const digest = createHash("sha256")
        .update(readFileSync(resolve(process.cwd(), file), "utf8").replace(/\r\n?/g, "\n"))
        .digest("hex")
        .toUpperCase();
