...
import type { ArtVariant } from "@/core/domain/room";
import styles from "./pinned-photo.module.css";

export function PinnedPhoto({ variant, note, imageDataUrl, imageName, className = "" }: { readonly variant: ArtVariant; readonly note?: string | null; readonly imageDataUrl?: string; readonly imageName?: string; readonly className?: string }) {
  return (
